...
namespace Project.COMMON.Tools
{
    ...
    {
        public static void Send(string receiver, string password= "anfldwxpvnnzavca", string body="Hesap Aktivasyon", string subject="Boyner", string sender = "TeknoromaProjects@gmail.com")
        {
